bde - A template for scikit-learn contributions
============================================================
...
**bde** is a template project for [scikit-learn](https://scikit-learn.org)
...
contribution: https://contrib.scikit-learn.org/bde
